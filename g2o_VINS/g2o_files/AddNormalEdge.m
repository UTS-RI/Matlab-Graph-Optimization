...
%     if strcmp(  NodeTypeName_B,NodeTypeName_A  )
%     Graph.Edges{SizeEdges+1}.Jacobian.(NodeTypeName_B).JacobianIndex=[   index_A   ;    index_B    ];
%     else Graph.Edges{SizeEdges+1}.Jacobian.(NodeTypeName_B).JacobianIndex=index_B;
%     end
