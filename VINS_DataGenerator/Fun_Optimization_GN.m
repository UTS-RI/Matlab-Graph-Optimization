function [ newLinearizedPoint ] = Fun_Optimization_GN(  Feature, IMUfactorMeasurement, Camera, Inf_Matrix, LinearizedPoint )
...
dx=-A\(SparseJacobian_matrix'*Inf_Matrix*FullErrorVector);
...
FullErrorVector'*Inf_Matrix*FullErrorVector
